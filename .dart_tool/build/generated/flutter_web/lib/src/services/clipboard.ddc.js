define(['dart_sdk', 'packages/flutter_web/src/foundation/assertions', 'packages/flutter_web_ui/ui', 'packages/flutter_web/io'], function(dart_sdk, assertions, ui, io) {
  ...
  src__services__platform_views.AndroidViewController = class AndroidViewController extends core.Object {
    ...
    addOnPlatformViewCreatedListener(listener) {
      if (!(listener != null)) dart.assertFailed();
      if (!!dart.equals(this[_state], src__services__platform_views._PlatformViewState.disposed)) dart.assertFailed();
    ...
    setSize(size) {
      return async.async(dart.void, (function* setSize() {
        if (!!dart.equals(this[_state], src__services__platform_views._PlatformViewState.disposed)) dart.assertFailed("trying to size a disposed Android View. View id: " + dart.str(this.id));
        if (!(size != null)) dart.assertFailed();
    ...
    setLayoutDirection(layoutDirection) {
      return async.async(dart.void, (function* setLayoutDirection() {
        if (!!dart.equals(this[_state], src__services__platform_views._PlatformViewState.disposed)) dart.assertFailed("trying to set a layout direction for a disposed UIView. View id: " + dart.str(this.id));
  ...
  src__services__platform_views.UiKitViewController = class UiKitViewController extends core.Object {
    ...
    setLayoutDirection(layoutDirection) {
      return async.async(dart.void, (function* setLayoutDirection() {
        if (!!dart.test(this[_debugDisposed])) dart.assertFailed("trying to set a layout direction for a disposed iOS UIView. View id: " + dart.str(this.id));
        if (dart.equals(layoutDirection, this[_layoutDirection])) return;
        if (!(layoutDirection != null)) dart.assertFailed();
        this[_layoutDirection] = layoutDirection;
      }).bind(this));
  ...
  src__services__platform_views.HtmlViewController = class HtmlViewController extends core.Object {
    ...
    setSize(size) {
      return async.async(dart.void, (function* setSize() {
        if (!!dart.equals(this[_state], src__services__platform_views._PlatformViewState.disposed)) dart.assertFailed("trying to size a disposed HTML View. View id: " + dart.str(this.id));
        if (!(size != null)) dart.assertFailed();
        if (!!dart.test(size.isEmpty)) dart.assertFailed();
        if (dart.equals(this[_state], src__services__platform_views._PlatformViewState.waitingForSize)) return this[_create](size);
        yield src__services__system_channels.SystemChannels.platform_views.invokeMethod(dart.void, "resize", new (IdentityMapOfString$dynamic()).from(["id", this.id, "width", size.width, "height", size.height]));
    ...
    setLayoutDirection(layoutDirection) {
      return async.async(dart.void, (function* setLayoutDirection() {
        if (!!dart.equals(this[_state], src__services__platform_views._PlatformViewState.disposed)) dart.assertFailed("trying to set a layout direction for a disposed HTML View. View id: " + dart.str(this.id));
        if (dart.equals(layoutDirection, this[_layoutDirection])) return;
        if (!(layoutDirection != null)) dart.assertFailed();
        this[_layoutDirection] = layoutDirection;
        if (dart.equals(this[_state], src__services__platform_views._PlatformViewState.waitingForSize)) return;
