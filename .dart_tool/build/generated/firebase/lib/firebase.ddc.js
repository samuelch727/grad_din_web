define(['dart_sdk', 'packages/firebase/src/app'], function(dart_sdk, app) {
  ...
  const src__interop__firebase_interop = app.src__interop__firebase_interop;
  ...
  const src__interop__app_interop = app.src__interop__app_interop;
  const src__utils = app.src__utils;
  const src__interop__messaging_interop = app.src__interop__messaging_interop;
  ...
  src__top_level.initializeApp = function(opts) {
    ...
    try {
      return src__app.App.getInstance(src__interop__firebase_interop.initializeApp(src__interop__firebase_interop.FirebaseOptions.new({apiKey: apiKey, authDomain: authDomain, databaseURL: databaseURL, projectId: projectId, storageBucket: storageBucket, messagingSenderId: messagingSenderId}), name));
    } catch (e$) {
  ...
  src__top_level.app = function(name) {
    ...
    let jsObject = name != null ? src__interop__firebase_interop.app(name) : src__interop__firebase_interop.app();
    return src__app.App.getInstance(jsObject);
  };
  src__top_level.auth = function(app) {
    if (app === void 0) app = null;
    let jsObject = app != null ? src__interop__firebase_interop.auth(app.jsObject) : src__interop__firebase_interop.auth();
    return src__auth.Auth.getInstance(jsObject);
  };
  src__top_level.database = function(app) {
    if (app === void 0) app = null;
    let jsObject = app != null ? src__interop__firebase_interop.database(app.jsObject) : src__interop__firebase_interop.database();
    return src__database.Database.getInstance(jsObject);
  };
  src__top_level.storage = function(app) {
    if (app === void 0) app = null;
    let jsObject = app != null ? src__interop__firebase_interop.storage(app.jsObject) : src__interop__firebase_interop.storage();
    return src__storage.Storage.getInstance(jsObject);
  };
  src__top_level.firestore = function(app) {
    if (app === void 0) app = null;
    let jsObject = app != null ? src__interop__firebase_interop.firestore(app.jsObject) : src__interop__firebase_interop.firestore();
    return src__firestore.Firestore.getInstance(jsObject);
  };
  src__top_level.messaging = function(app) {
    if (app === void 0) app = null;
    let jsObject = app != null ? src__interop__firebase_interop.messaging(app.jsObject) : src__interop__firebase_interop.messaging();
  ...
  dart.copyProperties(src__top_level, {
    get apps() {
      return src__interop__firebase_interop.apps[$map](src__app.App, dart.fn(e => src__app.App.getInstance(src__interop__app_interop.AppJsImpl._check(e)), dynamicToApp()))[$toList]();
    }
  });
  ...
  src__messaging.Messaging = class Messaging extends src__js.JsObjectWrapper$(src__interop__messaging_interop.MessagingJsImpl) {
    ...
    [_createOnMessageStream](controller) {
      if (controller == null) {
        ...
        let nextWrapper = js.allowInterop(dynamicToNull(), dart.fn(payload => {
          controller.add(new src__messaging.Payload._fromJsObject(src__interop__messaging_interop.PayloadJsImpl._check(payload)));
        }, dynamicToNull()));
  ...
  src__messaging.Notification = class Notification extends src__js.JsObjectWrapper$(src__interop__messaging_interop.NotificationJsImpl) {
    get title() {
  ...
  src__messaging.Payload = class Payload extends src__js.JsObjectWrapper$(src__interop__messaging_interop.PayloadJsImpl) {
    get notification() {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["org-dartlang-app:///packages/firebase/src/top_level.dart","org-dartlang-app:///packages/firebase/src/messaging.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IA8He;;;;;;;AAIQ,YAAA,AAAwC,6CAAR;IAAQ;;;IAH3B;;EAAQ;;;;;;;;;;QAlGhC;QACD;QACA;QACA;QACA;QACA;QACA;IACT,AAAK,IAAD,IAAC,OAAL,OAAS,iCAAJ;;AAGH,YAAW,0BAAY,6CACV,4DACG,MAAM,cACF,UAAU,eACT,WAAW,aACb,SAAS,iBACL,aAAa,qBACT,iBAAiB,IACxC,IAAI;;UACD;AACP,oBAAI,kCAAmB,CAAC;QACtB,WAAM,oDAA6B;;MAGrC;;EAEJ;gCAWgB;;AACV,mBAAY,AAAc,IAAV,IAAI,OAAQ,mCAAa,IAAI,IAAI;AAErD,UAAW,0BAAY,QAAQ;EACjC;iCAKe;;AACT,mBAAY,AAAa,GAAV,IAAI,OAAQ,oCAAc,AAAI,GAAD,aAAa;AAE7D,UAAY,4BAAY,QAAQ;EAClC;qCAQuB;;AACjB,mBACC,AAAa,GAAV,IAAI,OAAQ,